...
class Ui_MainWindow(object):
    ...
    def pick(self, pick):
        ...
        self.lbl_my_attack.setText(str(self.my_attack))
        self.lbl_my_defense.setText(str(self.my_defense))
        self.lbl_my_element.setText(str(self.my_element))

        self.lbl_enemy_attack.setText(str(self.en_attack))
        self.lbl_enemy_defense.setText(str(self.en_defense))
        self.lbl_enemy_element.setText(str(self.en_element))

        self.total_p1 = int(p1_atk) - int(p2_def)
        # self.total_p2 = self.deck_p2['attack'] - self.deck_p1['defense']
        print(self.total_p1)
